...
#####################################################
	...
	config.usage.show_picon_bkgrn = ConfigSelection(default = "none", choices = [("none", _("Disabled")), ("transparent", _("Transparent")), ("blue", _("Blue")), ("red", _("Red")), ("black", _("Black")), ("white", _("White")), ("lightgrey", _("Light Grey")), ("grey", _("Grey"))])
...
#					("merlinepgcenter", _("Show Merlin EPG Center")),
	...
	config.epgselection.infobar_itemsperpage = ConfigSelectionNumber(default = 4, stepwidth = 1, min = 1, max = 4, wraparound = True)
	...
	config.epgselection.infobar_prevtimeperiod = ConfigSelection(default = "120", choices = [("60", _("%d minutes") % 60), ("90", _("%d minutes") % 90), ("120", _("%d minutes") % 120), ("150", _("%d minutes") % 150), ("180", _("%d minutes") % 180), ("210", _("%d minutes") % 210), ("240", _("%d minutes") % 240), ("270", _("%d minutes") % 270), ("300", _("%d minutes") % 300)])
	...
	config.epgselection.infobar_servicewidth = ConfigSelectionNumber(default = 490, stepwidth = 1, min = 70, max = 500, wraparound = True)
	config.epgselection.infobar_piconwidth = ConfigSelectionNumber(default = 100, stepwidth = 1, min = 50, max = 500, wraparound = True)
	config.epgselection.infobar_infowidth = ConfigSelectionNumber(default = 75, stepwidth = 25, min = 0, max = 150, wraparound = True)
	...
	config.epgselection.graph_prevtimeperiod = ConfigSelection(default = "120", choices = [("60", _("%d minutes") % 60), ("90", _("%d minutes") % 90), ("120", _("%d minutes") % 120), ("150", _("%d minutes") % 150), ("180", _("%d minutes") % 180), ("210", _("%d minutes") % 210), ("240", _("%d minutes") % 240), ("270", _("%d minutes") % 270), ("300", _("%d minutes") % 300)])
	...
	config.epgselection.graph_servicetitle_mode = ConfigSelection(default = "servicenumber+servicename", choices = [("servicename", _("Service Name")),("picon", _("Picon")),("servicenumber+picon+servicename", _("Service Number, Picon and Service Name")),("servicenumber+servicename", _("Service Number and Service Name")),("picon+servicename", _("Picon and Service Name")) ])
	...
	config.epgselection.graph_servicewidth = ConfigSelectionNumber(default = 490, stepwidth = 1, min = 70, max = 500, wraparound = True)
	config.epgselection.graph_piconwidth = ConfigSelectionNumber(default = 100, stepwidth = 1, min = 50, max = 500, wraparound = True)
	config.epgselection.graph_infowidth = ConfigSelectionNumber(default = 75, stepwidth = 25, min = 0, max = 150, wraparound = True)
